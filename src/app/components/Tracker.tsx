        ...
        {[...Array(6)].map((_, idx) => (
          <div key={idx}>
            ...
            <div className="flex w-full flex-col">
              <div className="card bg-base-300 rounded-box grid h-[63px]">
                <div className="flex justify-between px-[18px] pt-[6px]">
                  <div>- 5000원</div>
                  <div>
                    <div className="badge badge-error">임대</div>
                    <div className="badge badge-success">식사</div>
                    <div className="badge badge-secondary">교통</div>
                  </div>
                </div>
